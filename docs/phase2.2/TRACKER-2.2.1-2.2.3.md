...
- [ ] 2.2.1.1 retrieved-document-contract-and-prompt-policy — spec: `docs/phase2.2/2.2.1-evaluation-fidelity-and-baseline-correctness/2.2.1.1-retrieved-document-contract-and-prompt-policy.md` — fix the `document` vs `text` blank-body bug (P0 evidence loss), establish one shared evidence contract and one authoritative prompt-policy builder.
